...
import torch
from SCE.features.TextFeatureExtractor import TextFeatureExtractor
...
class BERTFeatureExtractor(TextFeatureExtractor):
    ...
    def get_feature_batch(self, text_batch):
        ...
        # print(token_ids_batch.shape)
        # print(attn_mask_batch.shape)
        # print(seg_ids_batch.shape)
        ...
        # embedding =  pooler_output.cpu().numpy() # pooler output is the embedding we need
